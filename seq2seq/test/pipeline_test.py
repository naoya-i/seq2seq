...
class PipelineTest(tf.test.TestCase):
  ...
  def test_train_infer_sampled_softmax(self):
    """Same as above, but using sampled softmax
    """
    # Create dummy data
    sources_train, targets_train = test_utils.create_temp_parallel_data(
        sources=["a a a a", "b b b b", "z z z z", "笑 笑 笑 笑"],
        targets=["b b b b", "a a a a", "z z z z", "泣 泣 泣 泣"])
    sources_dev, targets_dev = test_utils.create_temp_parallel_data(
        sources=["a a", "b b", "z z z", "笑 笑 笑"],
        targets=["b b", "a a", "z z z", "泣 泣 泣"])
    vocab_source = test_utils.create_temporary_vocab_file(["a", "b", "z", "笑"])
    vocab_target = test_utils.create_temporary_vocab_file(["a", "b", "z", "泣"])
